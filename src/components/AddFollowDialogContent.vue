<template>
  <div class="addPointDialogContainer">
    <div class="BISelectContainer">
      <el-dialog title="Add New Followup" :visible.sync="dialogVisible" width="30%" @open="getRootData" @close="handleClose('ruleForm')" class="addPointDialog">
            ...
            <el-row>
              <el-col :span="10">
                <el-select v-model="ruleForm.biSelected" value-key="_id" filterable clearable allow-create placeholder="Please select BI">
                  <el-option v-for="item in biList" :key="item.storykey" :label="item.storykey" :value="item">
                  </el-option>
                </el-select>
              </el-col>
              <el-col :span="10">
