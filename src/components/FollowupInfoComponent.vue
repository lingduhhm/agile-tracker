<template>
  <el-container>
    <el-header style="text-align: left; height: 40px; line-height: 25px" class="blockSheetHeader">
      <el-row>
        <el-col :span="20">
          <span class="textBold">Followup Issues</span>
        </el-col>
        <el-col :span="4">
    ...
    <el-main style="padding-top: 5px; padding-left:0px; padding-right:0px">
      ...
      <el-row style="text-align: left; padding-left: 20px; margin: 5px 0 7px">
        <el-col :span="20">
          <span class="textBold" style="text-align: left">Current Followups:</span>
        </el-col>
        <el-col :span="4">
      ...
      <el-row style="text-align: left; padding-left: 20px" class="blockSheetSummary">
        <el-col :span="20">
          <span class="textBold" style="text-align: left">Previous Followups：</span>
        </el-col>
        <el-col :span="4">
      ...
      <el-row style="text-align: left; padding-left: 20px; margin-bottom: 3px">
        <el-col :span="12">
          <span class="textBold">Follows ({{issues.length}})</span>
        </el-col>
        <el-col :span="12">
          <span>Show All</span>
